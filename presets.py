...
🔰 <a href='t.me/infinitybotzz'><b>@Infinitybotz</b></a>   
    """
    INFO_CHAT_TYPES = """
𝙔𝙤𝙪 𝙘𝙖𝙣 𝙚𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙛𝙤𝙡𝙡𝙤𝙬𝙞𝙣𝙜 𝙩𝙮𝙥𝙚𝙨:

𝐈𝐝           : 123456789 (-𝟏𝟎𝟎 𝐧𝐨𝐭 𝐫𝐞𝐪.)
𝐈𝐧𝐯𝐢𝐭𝐞 𝐥𝐢𝐧𝐤𝐬  : https://t.me/joinchat/......
𝐏𝐮𝐛𝐥𝐢𝐜 𝐥𝐢𝐧𝐤𝐬 : https://t.me/channel_name
𝐔𝐬𝐞𝐫𝐧𝐚𝐦𝐞𝐬  : @𝐩𝐲𝐭𝐡𝐨𝐧
    """
    SELECTED_TYPE = """
𝙔𝙤𝙪 𝙝𝙖𝙫𝙚 𝙨𝙚𝙡𝙚𝙘𝙩𝙚𝙙:
...
𝐓𝐲𝐩𝐞𝐬: 📚:{} | 🎞:{} | 🔊:{} | 📸:{} | 🗣:{}
    ...
    COPIED_MESSAGES = "<b><a href='https://t.me/infinitybotzz'>Media Copied</a></b>"
...
H̶e̶r̶o̶k̶u̶ f̶r̶e̶e̶ d̶y̶n̶o̶s̶ r̶e̶s̶t̶a̶r̶t̶s̶ .
    ...
    TARGET_CFG_LOAD_MSG = "<b><u>Imported</u>  ✅</b>\n\n<code>An index of the given target chat found in my database. " \
                          "It has been loaded to memory.</code>\n\n<b><i>Proceeding to clone..</i></b>"